...
# Add backport to debian stretch so we have java8
	sed \
		-e '$adeb http://deb.debian.org/debian stretch-backports main' \
...
ARG TOS_DI_VERS=7.3.1
ARG TOS_DI_FULLVERS=20200219_1130-V${TOS_DI_VERS}
...
# optimize memory in TOS_DI
	sed \
		-e 's/-Xms512m/-Xms1024m/' \
		-e 's/-Xmx1536m/-Xms4096m/' \
		-i /apps/TOS_DI/TOS_DI-linux-gtk-x86_64.ini
